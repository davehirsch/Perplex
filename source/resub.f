...
1000  format (/,'WARNING: composition of solution ',a,' has reached an',
     *          ' internal limit (',f5.3,')',/,
     *          'on site ',i1,' for species ',i2,'.',/,
c/,'If this warning'
c     *         ,' occurs during auto-refinement, the problem can be ',
c     *          'circumvented',/,'by increasing the auto_refine_slop ',
c     *          'specified in perplex_option.dat.',//,
...
c----------------------------------------------------------------------
      ...
      integer i,j,k,l,ipvt,jzero(k5), idead
