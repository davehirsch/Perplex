      ...
      integer k16,k17,k18,k19,k20,k21,k22,k23,kd2
      integer l2,l3,l5,l6,l7,l8
      integer m0,m1,m2,m3,m4,m6,m7,m8,m9,m10,m11,m12,m13,m14,m15
      integer msp,mst,nsp,mdim,ms1
      integer tpAlgn, btAlgn, mdAlgn, ltAlgn, rtAlgn, ctAlgn
      integer useMnX
      parameter (tpAlgn=0,mdAlgn=1,btAlgn=2,ltAlgn=0,ctAlgn=1,
     *            rtAlgn=2,useMnX=32700)
...
!                                 k23 - max number of phases to be fractionated
      parameter (k0=25,k1=750000,k2=100000,k3=500,k4=22,k5=15)
      parameter (k9=30,k10=240,k12=15,k13=i0*k1,k14=18,k15=3,k16=30)
      parameter (k17=5,k18=29*k1)
      parameter (k19=100,k21=1500000,k20=i0*k21,k22=i0*k19,k23=5)
