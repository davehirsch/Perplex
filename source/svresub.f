...
c               if (dabs(dg-g(id)).gt.1d-8) then 
c                   write (*,*) 'wacka wacka2',g(id)-dg,id
c               end if
...
c               if (dabs(gsol(i)-g(id)).gt.1d-8) then 
c                   write (*,*) 'wacka wacka0',g(id)-gsol(i),id
c               end if
c               if (dabs(gsol1(i)-g(id)).gt.1d-8) then 
c                  write (*,*) 'wacka wacka1',g(id)-gsol1(i),id
c               end if 
...
c                                 options from perplex_option.dat
      ...
      integer ipvt
      double precision aa,d
      common/ cst301 /aa(k5,k5),d(k5),ipvt(k5)
...
c                                 necessary?
      ...
      if (hcp.eq.1.or.iopt(10).eq.0.or.isoct.eq.0) then 
...
c----------------------------------------------------------------------
      ...
      integer jdv(*),inc,i,j,idead,jphct,mpt,npt,is(*),id
